enem-sc/
├── docs
│   ├── Documetos_Edital_018_2025_CNPq_MIR.pdf
│   ├── estudo_01_perfil_socioeconomico_do_candidato
│   │   ├── Analise_dados_enem_pandemia.html
│   │   ├── Estudos_do_ENEM.html
│   │   ├── painel_completo_enem.pdf
│   │   └── Proposta-de-Análise-Interativa-do-Desempenho-no-ENEM.html
│   ├── estudo_02_qualidade_de_ensino_nos_institutos_federais
│   │   └── index.html
│   ├── estudo_03_melhores_e_piores_desempenhos__ranking_de_escolas
│   │   └── index.html
│   ├── estudo_04_revisao_bibliometrica
│   │   └── index.html
│   ├── estudo_05_correlacao_habilidades_vs_situacaoproblema
│   │   ├── index.html
│   │   └── Painel_ENEM_TRI_ML3P.html
...
│   └── src
├── estudo_05_correlacao_habilidades_vs_situacaoproblema
│   ├── 0_Referencias_Originais
│   │   ├── ENEM_DNA_O_Mapa_da_Coerência_Cognitiva.pdf
│   │   └── PodCast_Método_TBR-2D-BO
│   │       ├── 100.m4a
│   │       ├── 132.m4a
│   │       ├── 133.m4a
│   │       ├── 96.m4a
│   │       ├── 97.m4a
│   │       ├── 99.m4a
│   │       ├── Decodificando_o_ENEM.mp4
│   │       └── O_ENEM_avalia_as_competências_que_promete_.m4a
│   ├── 1_Contextualizacao_Diagnostico
│   │   ├── index.html
│   │   └── README.md
│   ├── 2_Guia_Codificacao
│   │   ├── index.html
│   │   └── README.md
│   ├── 3_Protocolo_Triangulacao
│   │   ├── index.html
│   │   └── README.md
│   ├── 4_Integracao_TRI
│   │   ├── index.html
│   │   └── README.md
│   ├── 5_Resultados_Relatorios
│   │   ├── index.html
│   │   └── README.md
│   ├── Estudo_5_Correlacao_Habilidades_vs_Situacao_Problema
│   │   └── Protocolo de Triangulação e Guia de Codificação TBR-2D-BO.md
│   ├── index.html
│   ├── Projeto-ENEM-TBR-2D-BO.md
│   └── Protocolo.html
├── estudo_06_desigualdade_meritocracia_e_propostas_de_politicas_publicas
│   ├── data
│   ├── figures
